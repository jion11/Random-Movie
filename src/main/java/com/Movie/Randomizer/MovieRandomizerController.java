...
*/
    ...
    public void deleteMovie(@RequestParam("movieToDelete") String movieToDelete) {
    ...
    public CorsFilter corsFilter() {
        ...
        corsConfiguration.setAllowedOrigins(Arrays.asList("https://randomovie.herokuapp.com/"));
